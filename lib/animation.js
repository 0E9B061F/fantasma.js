...
class Playback {
    ...
    get beginT() { return this.reverse ? 1 : 0 }
    get endT() { return this.reverse ? 0 : 1 }
    get beginMs() { return this.reverse ? this.animation.totalTime : 0 }
    get endMs() { return this.reverse ? 0 : this.animation.totalTime }
    get direction() { return this.reverse ? -1 : 1 }
    get firstLoop() { return this.loops == 0 }
    get ended() {
        if (this.reverse) return this.rt <= 0
